...
# @class_declaration nobuckalma_sync_movistock #
class nobuckalma_sync_movistock(interna_movistock, helpers.MixinConAcciones):
    pass
...
class movistock(nobuckalma_sync_movistock, helpers.MixinConAcciones):
    pass
